...
CTFrontendBuilder.controller("ComponentsStates", function($scope) {
    ...
    $scope.switchState = function(state, setClass, id) {
        ...
        // open advanced settings tab if it is closed and state is different from original
        if (state != 'original' && !$scope.actionTabs['advancedSettings']) {
            //$scope.switchActionTab('advancedSettings'); 
        }
