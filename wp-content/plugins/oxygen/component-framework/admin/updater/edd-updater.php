...
$oxygen_free = new OxygenMainPluginUpdater( array(
		"prefix" 		=> "oxygen_",
		"plugin_name" 	=> "Components & Design Sets",
		"priority" 		=> 10,
		"license_text" 	=> __('Enter your license key to get access to Components and Design Sets', 'component-theme')
	) );


$design_sets = new OxygenMainPluginUpdater( array(
		"prefix" 		=> "oxygen_free_",
		"plugin_name" 	=> "Oxygen",
		"priority" 		=> 5
) );