<div class="ct-template-anchors">
	...
	<label>
		<input class="ct-template-anchor" type="radio" name="ct_template_type" value="archive" <?php echo checked( $template_type, "archive"); ?>>
		<?php _e("Archive", "component-theme"); ?>
	</label>
	<label>
		<input class="ct-template-anchor" type="radio" name="ct_template_type" value="single_post" <?php echo checked( $template_type, "single_post"); ?>>
		<?php _e("Single", "component-theme"); ?>
	</label>

	<label>
		<input class="ct-template-anchor" type="radio" name="ct_template_type" value="reusable_part" <?php echo checked( $template_type, "reusable_part"); ?>>
		<?php _e("Re-usable part", "component-theme"); ?>
	</label>
	
	<label>
		<input class="ct-template-anchor" type="radio" name="ct_template_type" value="header_footer" <?php echo checked( $template_type, "header_footer"); ?>>
		<?php _e("Header/Footer", "component-theme"); ?>
	</label>

	<label>
		<input class="ct-template-anchor" type="radio" name="ct_template_type" value="other_template" <?php echo checked( $template_type, "other_template"); ?>>
...
<div id="ct_archive" class="ct-template-section">
	...
	<select name="ct_template_custom_taxonomies[]" id="ct_template_custom_taxonomies" multiple="multiple">
		...
		foreach ( $taxonomies as $taxonomy ) : 
			...
			<optgroup label="<?php echo $taxonomy->labels->name . " (" . $taxonomy->name . ")"; ?>">
				
				<option value="<?php echo "all_".$taxonomy->name; ?>" 
					<?php if ( in_array( "all_".$taxonomy->name, $template_custom_taxonomies ) ) echo 'selected="selected"'; ?>>
					<?php _e( "All ", "component-theme" ); echo $taxonomy->labels->name; ?>
				</option>
	...
	<div id="ct_post_types" class="ct-template-options-section ct-section-active">
		...
		<div class="ct-template-column-left">
			...
			foreach ( $post_types as $post_type ) : 
				...
				<label>
					<input type="checkbox" name="ct_template_post_types[]" value="<?php echo $post_type->name; ?>" 
			...
			<?php endforeach; ?>
			<label>
				<input type="checkbox" name="ct_template_single_all" value="true" <?php echo checked( $template_single_all, "true"); ?>>
		...
		<div class="ct-template-column-left">
			<label>
				<input type="checkbox" id="ct_use_template_taxonomies" name="ct_use_template_taxonomies" value="true" <?php echo checked($use_taxonomies, "true"); ?>>
			...
			<div class="ct-template-taxonomies">
					...
					<div class="ct-template-taxonomy">
						...
						<?php foreach ( $taxonomies as $key => $value ) : ?>
							<option value="<?php echo $key; ?>">
								<?php echo $value->labels->singular_name; ?>
							</option>
						<?php endforeach; ?>
						</select>
				...
				<div class="ct-template-taxonomy">
					...
					<select name="ct_taxonomy_names[]">
					<?php foreach ( $taxonomies as $key => $value ) : ?>
						<option value="<?php echo $key; ?>" <?php echo selected( $key, $template_taxonomy_name ); ?>>
							<?php echo $value->labels->singular_name; ?>
						</option>
					<?php endforeach; ?>
					</select>
					<input type="text" name="ct_taxonomy_values[]" value="<?php echo $template_taxonomies['values'][$template_taxonomy_key]; ?>">
					<span class="ct-taxonomy-relation"><?php _e("And","component-theme"); ?></span>
					<span class="dashicons dashicons-trash ct-remove-taxonomy"></span>
					<span class="dashicons dashicons-plus ct-add-taxonomy"></span>
				</div>
...
<div id="ct_header_footer" class="ct-template-section">
	...
	<input type="text" name="ct_template_header_footer_name" value="<?php echo $template_header_footer_name ?>">
