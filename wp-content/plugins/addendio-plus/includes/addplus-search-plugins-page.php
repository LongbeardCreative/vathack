...
function addplus_search_plugins() {
...
?>
	...
	/*if (ADDENDIO_FREEMIUS_ENABLED) {
		if( addplus_fs()->is_pending_activation() ) {
			_e('You haven\'t activated your account. Please check your email and click on the link we sent you...','addendio-plus');
		}

		if( !addplus_fs()->is_registered() ) {
			_e('You need to <a href="'.ADDPLUS_ADMIN_FOLDER.'options-general.php?page=addplus_addendio_settings">activate your account</a> to use Addendio Plus. <a href="'.ADDPLUS_ADMIN_FOLDER.'options-general.php?page=addplus_addendio_settings">ACTIVATE NOW!</a> It only takes a couple of clicks...','addendio-plus');
		}
		}
	*/
	?>
